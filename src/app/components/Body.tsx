...
import im2 from '../../../public/logo-no-background(1) 1.png'
function Body() {
return (
    <div>
 ...
 <div className="absolute top-0 text-center mt-44  flex flex-col justify-center text-white" style={{marginLeft: "450px"}}>
                        <img className='h-32 ' style={{width:"470px"}} src='https://www.mlchc.org/sites/default/files/styles/max_650x650/public/2022-03/nutrition_image2.jpg?itok=fUi0J40D'/>
                    </div>
